...
export default function EventSalesChart({ data }) {
    ...
    const eventSales = async () => {
        try {
            ...
            const { data } = await axios.get(`${process.env.REACT_APP_API}/api/v1/admin/event-sales`, config)
